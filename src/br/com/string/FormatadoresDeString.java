	...
	public static void main(String[] args) {
		...
		*/
		...
		//Metodo printf() é usado para exibir dados formatados no console f e de formatted
		 ...
		 /*Temos dois indices um implicito e o explicito que não afeta o implicito por isso imprime Fabio duas vezes
		 	ele usou o explicito %1$ mas não alterou o implicitou que continuou com o indice 1 imprimindo Fabio e mudando o indice para 2
		 */
